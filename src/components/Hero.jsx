    ...
    <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        >
          ...
          <span className="text-pink-500">Your Dream Home</span>
        </motion.h1>
        ...
        >
          <Link
            to="/products"
            className="px-8 py-4 bg-pink-600 hover:bg-pink-700 text-white font-bold rounded-full transition-all transform hover:scale-105 shadow-lg shadow-pink-600/30"
          >
            Explore Collection
          </Link>
          <Link
      ...
      <motion.div
        ...
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-white opacity-50"
      >
        <svg
          className="w-6 h-6"
          fill="none"
