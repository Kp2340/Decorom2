      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 font-sans">
          <div className="text-center">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-[#E59500]"></div>
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 font-sans">
          <div className="bg-white rounded-3xl shadow-xl p-8 max-w-md w-full text-center border border-gray-100">
            ...
            <button 
              onClick={() => navigate("/")} 
              className="w-full bg-[#E59500] hover:bg-[#CC8400] text-white font-bold py-3 rounded-xl transition-all shadow-md active:scale-95"
            >
              Back to Showroom
            </button>
          </div>
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 font-sans focus:outline-none">
        <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFFDD0] rounded-full -mr-16 -mt-16 opacity-50" />
            
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
              <div>
                  <div className="flex items-center gap-2 mb-1">
                      <h1 className="text-3xl font-black text-[#2C3E50]">Track Order</h1>
                      <span className="text-[9px] bg-[#2C3E50] text-white px-2 py-0.5 rounded font-black tracking-widest uppercase">
              ...
              <div className="flex items-center gap-2">
                  <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full ring-1
                      ${orderData?.status === 'CANCELLED' ? 'bg-red-50 text-red-600 ring-red-100' : 'bg-[#FFFDD0] text-[#E59500] ring-[#E59500]/20'}`}>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-end">
                ...
                <span className="text-3xl font-black text-[#E59500]">{progress}%</span>
              </div>
              <div className="w-full bg-gray-100 rounded-full h-4 overflow-hidden shadow-inner">
                <div
                  className="bg-gradient-to-r from-[#E59500] to-[#CC8400] h-full rounded-full transition-all duration-1000 ease-out"
                  ...
                  return (
                    <div key={stage.key} className="flex items-start gap-6 relative group">
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-xl shrink-0 z-10 transition-all duration-300
                        ${isCurrent ? "bg-[#E59500] text-white shadow-lg shadow-amber-200 rotate-12 scale-110" :
                      ...
                      <div className={`flex-1 pt-1 ${!isCurrent && !isDone ? "opacity-30" : ""}`}>
                        <p className={`font-black text-sm uppercase tracking-tight ${isCurrent ? "text-[#E59500]" : isDone ? "text-green-700" : "text-gray-400"}`}>
                          {stage.label}
                          {isCurrent && (
                            <span className="ml-3 text-[9px] bg-[#FFFDD0] text-[#E59500] px-2 py-0.5 rounded-md font-black animate-pulse uppercase">
                              Active
                            </span>
                          )}
                        </p>
