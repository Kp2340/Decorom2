    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-700">
        <section>
          ...
          <p>
            Welcome to Decorom. These terms and conditions outline the rules and
            regulations for the use of Decorom's Website. By accessing this
            website we assume you accept these terms and conditions. Do not
            continue to use Decorom if you do not agree to take all of the terms
        ...
        <section>
          ...
          <p>
            You must be at least 18 years of age to use this website. You agree
            to use the website only for lawful purposes and in a way that does
        ...
        <section>
          ...
          <p>
            Other than the content you own, under these Terms, Decorom and/or
        ...
        <section>
          ...
          <p>
            ...
            <strong>Pricing is subject to change</strong> without notice. We
        ...
        <section>
          ...
          <p>
            In no event shall Decorom, nor any of its officers, directors and
        ...
        <section>
          ...
          <p>
            ...
            the laws of the State of Gujarat, and you submit to the
            non-exclusive jurisdiction of the state and federal courts located
            in <strong>Ahmedabad, Gujarat</strong> for the resolution of any
            disputes.
          </p>
        </section>
