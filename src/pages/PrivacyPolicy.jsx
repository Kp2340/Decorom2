    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-700">
        <section>
          ...
          <p>
            When you visit Decorom, we collect certain information about your
          ...
          <ul className="list-disc ml-6 mt-2 space-y-1">
            <li>
              <strong>Personal Information:</strong> Name, billing address,
              shipping address, payment information, email address, and phone
              number.
            </li>
            <li>
              <strong>Device Information:</strong> Version of web browser, IP
              address, time zone, cookie information, what sites or products you
              view, search terms, and how you interact with the Site. We collect
              this for fraud detection and to optimize our site.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            it. Our website is scanned on a regular basis for security holes and
